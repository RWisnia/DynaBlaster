...
int main (int argc, char *argv[]) {
    ...
    while(running)
    {
        ...
        while(SDL_PollEvent(&event))
        {
            ...
            {
                case SDLK_LEFT:  character.x-=5; break;
        ...
        // Player
        SDL_Rect rect = { character.x, character.y, character.w, character.h };
        SDL_RenderCopyEx(renderer, SpriteImage, NULL, &rect, 0, NULL, 1);
